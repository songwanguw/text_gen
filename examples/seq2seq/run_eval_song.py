...
model_path = "/home/sonwang/work/data/train_dev_multilingual_kb/mbart-large-cc25-ft_epoch4_len62/best_tfmr"
...
translated_tokens = model.generate(input_ids = batch.input_ids, attention_mask=batch.attention_mask)
